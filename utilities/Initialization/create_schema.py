...
# Overall points leaderboard (IC)
print("Creating Overall Points Leaderboard IC")
sql = """
CREATE OR REPLACE VIEW overall_points_leaderboard_ic AS
SELECT
    cars.car_number,
    cars.team_name,
...
JOIN carreg ON cars.car_number = carreg.car_number
...
# Overall points leaderboard (EV)
print("Creating Overall Points Leaderboard EV")
sql = """
CREATE OR REPLACE VIEW overall_points_leaderboard_ev AS
SELECT
    cars.car_number,
    cars.team_name,
    cars.team_abbreviation,
