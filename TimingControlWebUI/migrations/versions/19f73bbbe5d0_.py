...
Revision ID: 19f73bbbe5d0
Revises: 
Create Date: 2024-08-01 21:13:15.367753
...
def upgrade():
    ...
    with op.batch_alter_table('car_reg', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_car_reg_car_number'), ['car_number'], unique=False)
        batch_op.create_index(batch_op.f('ix_car_reg_tag'), ['tag'], unique=False)
        batch_op.create_index(batch_op.f('ix_car_reg_team_name'), ['team_name'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('car_reg', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_car_reg_team_name'))
        batch_op.drop_index(batch_op.f('ix_car_reg_tag'))
        batch_op.drop_index(batch_op.f('ix_car_reg_car_number'))

    op.drop_table('car_reg')
    # ### end Alembic commands ###
